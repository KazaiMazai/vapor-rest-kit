...
extension ResourceControllerBuilder {
    func create<Input>(input: Input.Type, middleware: ControllerMiddleware<Model> = .defaultMiddleware) -> ResourceControllerBuilder
        where
    ...
    func update<Input>(input: Input.Type, middleware: ControllerMiddleware<Model> = .defaultMiddleware) -> ResourceControllerBuilder
    ...
    func patch<Input>(input: Input.Type, middleware: ControllerMiddleware<Model> = .defaultMiddleware) -> ResourceControllerBuilder
        where
    ...
    func delete(forced: Bool = false, middleware: ControllerMiddleware<Model> = .defaultMiddleware) -> ResourceControllerBuilder {
