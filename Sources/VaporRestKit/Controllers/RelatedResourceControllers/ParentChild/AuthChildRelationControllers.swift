...
struct CreateAuthChildrenRelationController<Model, RelatedModel, Output, Input, EagerLoading>: CreatableRelationController, AuthChildrenResourceRelationProvider
