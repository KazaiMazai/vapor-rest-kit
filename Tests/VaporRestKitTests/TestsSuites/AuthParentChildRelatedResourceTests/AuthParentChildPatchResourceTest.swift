...
final class AuthParentChildPatchResourceTests: BaseVaporRestKitTest {
...
final class AuthParentChildPatchResourceDeprecatedAPITests: BaseVaporRestKitDeprecatedAPITest {
    func testCreateWithValidData() throws {
        try routes()
