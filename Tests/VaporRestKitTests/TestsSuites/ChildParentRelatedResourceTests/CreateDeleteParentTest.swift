...
final class CreateParentTests: BaseVaporRestKitTest {
    ...
    func testCreateWithEmptyData() throws {
        ...
        .test(.POST, "v1/stars/1/belongs/galaxies", body: Empty()) { res in
    ...
    func testCreateWithInvalidData() throws {
        ...
        }.test(.POST, "v1/stars/1/belongs/galaxies", body: Galaxy.Input(title: "M")) { res in
            XCTAssertEqual(res.status, .badRequest)
...
final class CreateParentDeprecatedAPITests: BaseVaporRestKitDeprecatedAPITest {
    func testCreateWithValidDataAndDelete() throws {
        try routes()
